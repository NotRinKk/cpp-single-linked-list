...
void TestFind() {
    ...
    numbers.PushFront(32);
    numbers.PushFront(42);
    numbers.PushFront(0);
    numbers.PushFront(-1);
    auto it1 = std::find(numbers.cbegin(), numbers.cend(), 42);
    auto it2 = std::find(numbers.cbegin(), numbers.cend(), -98);
    {
        assert(it1 != numbers.cend());
        assert(it2 == numbers.cend());
    }
